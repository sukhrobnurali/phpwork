...
return [
    ...
    */
    ...
    'custom' => [
        'attribute-name' => [
            'items' => 'Поле товара  обязательно для заполнения',
            'required_file' => 'Поле файл обязательно для заполнения',
            'required_reason' => 'Поле причина возврата обязательно для заполнения',
        ],
    ],
